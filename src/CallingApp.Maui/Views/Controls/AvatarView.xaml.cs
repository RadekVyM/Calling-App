namespace CallingApp.Maui.Views.Controls
{
    public partial class AvatarView : ContentView
    {
        ...
        private void ViewSizeChanged(object sender, EventArgs e)
        {
            ...
            AbsoluteLayout.SetLayoutBounds(topLabelFrame, new Rect(topLabelPosition, new Size(300, topLabel.Height)));
            AbsoluteLayout.SetLayoutBounds(imageGrid, new Rect(imageCenterPosition, imageGrid.Bounds.Size));
