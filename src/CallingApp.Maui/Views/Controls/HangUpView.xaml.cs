...
public partial class HangUpView : ContentView
{
    ...
    private async void PanUpdated(object sender, PanUpdatedEventArgs e)
    {
        ...
        switch (e.StatusType)
        {
            ...
            case GestureStatus.Canceled:
                ...
                {
                    { 0, 1, new Animation(v => drawable.ArcTranslationY = (float)v, drawable.ArcTranslationY, 0) },
                    { 0, 1, new Animation(v => drawable.TopTriangleTranslationY = (float)v, drawable.TopTriangleTranslationY, 0) },
                    { 0, 1, new Animation(v => drawable.BottomTriangleTranslationY = (float)v, drawable.BottomTriangleTranslationY, 0) },
                    { 0, 1, new Animation(v => drawable.TopTriangleOpacity = (float)v, drawable.TopTriangleOpacity, 1) },
                    { 0, 1, new Animation(v => drawable.BottomTriangleOpacity = (float)v, drawable.BottomTriangleOpacity, 1) },
                    { 0, 1, new Animation(v => graphicsView.Invalidate(), 0, 1) }
                };
    ...
    public async Task Show()
    {
        ...
        var animation = new Animation()
        {
            ...
            { 0.3, 0.5, new Animation(v => drawable.ArcOpacity = (float)v, 0, 1) },
            { 0, 1, new Animation(v => drawable.ArcRotation = (float)v, 0, 360) },
            { 0.8, 1, new Animation(v => drawable.TopTriangleScale = (float)v, 0, 1) },
            { 0.6, 1, new Animation(v => drawable.BottomTriangleScale = (float)v, 0, 1) },
            { 0, 1, new Animation(v => graphicsView.Invalidate(), 0, 1) }
        };
    ...
    {
        var animation = new Animation(v => this.Scale = v, 1, 0, easing: Easing.SpringIn);
